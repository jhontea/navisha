    ...
    <div className="space-y-5" aria-live="polite" aria-busy="true">
      ...
      <div className="flex flex-col items-center justify-center gap-3 py-2 text-center">
        ...
        {MESSAGES.map((msg, i) => (
          <p
            key={msg}
            className={`font-label-md text-label-md text-foreground transition-all duration-500 ${
        ...
        <p className="text-body-sm text-foreground-variant">
          Ini bisa memakan waktu beberapa menit, santai aja ☕
        </p>
      </div>

      <div className="rounded-xl border border-muted bg-white p-5">
