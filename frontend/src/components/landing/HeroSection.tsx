  ...
  return (
    <section className="flex flex-col items-center text-center py-20 md:py-32 max-w-max-width mx-auto px-margin-mobile md:px-margin-desktop">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
        <Link href="/login">
          <button className="group flex items-center gap-3 bg-white text-gray-800 px-8 py-4 rounded-xl font-label-md text-label-md shadow-lg border border-gray-200 hover:scale-[1.02] active:scale-[0.98] hover:shadow-xl transition-all duration-200">
